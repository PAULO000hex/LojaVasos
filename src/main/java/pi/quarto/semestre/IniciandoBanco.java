...
public class IniciandoBanco implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * ; Produto p1 = new
		 * Produto("Terraço",descricao,"18.9",67.99,"Marrom",29,true,"vaso1.jpg");
		 * Produto p2 = new
		 * Produto("Azeleias",descricao,"18.9",34.99,"Bege",29,true,"vaso2.jpg");
		 * Produto p3 = new
		 * Produto("Palmeira",descricao,"18.9",68.99,"Terra",29,true,"vaso3.jpg");
		 * Produto p4 = new
		 * Produto("Kalanchoe",descricao,"18.9",97.99,"Preto",29,true,"vaso4.jpg");
		 * Produto p5 = new
		 * Produto("Cristaleira",descricao,"18.9",27.99,"Branco",29,true,"vaso5.jpg");
		 * Produto p6 = new
		 * Produto("Plantio",descricao,"18.9",21.99,"Marrom",29,true,"vaso6.jpg");
		 * Produto p7 = new
		 * Produto("Diversos",descricao,"18.9",10.99,"Variado",29,true,"vaso7.jpg");
		 * Produto p8 = new
		 * Produto("Vaso Bola",descricao,"18.9",98.99,"Vinho",29,true,"vaso8.jpg");
		 * 
