...
public class ServiceUsuario {
	...
	public void salvarUsuarioc(Cliente user) throws Exception {

		try {
			if (clienterepository.findByEmail(user.getEmail()) != null) {
				throw new EmailExistsException("Já existe um email cadastrado para: " + user.getEmail());
			}
			user.setSenha(Util.md5(user.getSenha()));
		} catch (NoSuchAlgorithmException e) {
	...
	public void editarUsuarioc(Cliente user) throws Exception {
